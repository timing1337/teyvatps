...
use QueryCurrRegionHttpRsp;
use QueryRegionListHttpRsp;
use React\Http\HttpServer;
use React\Http\Message\Response;
use React\Socket\SocketServer;
use RegionInfo;
use RegionSimpleInfo;
use TeyvatPS\Config;
...
class DispatchServer
{
    ...
    public static function init(): void
    {
            ...
            function (ServerRequestInterface $request) {
                ...
                try {
                    ...
                    if ($url === '/' || $url === '/favicon.ico') {
                        ...
                        $response = $route !== null ? ($route)($request)
                            : $response;
                    }
        ...
        $httpServer->listen(
            new SocketServer('tls://0.0.0.0:443', [
                'tls' => [
                    'local_cert' => FolderConstants::DATA_FOLDER
                        . 'cert/cert.pem',
                ],
            ])
        );
    ...
    public static function registerRoutes(): void
    {
        ...
        self::$routes['/query_cur_region'] = function (
            ServerRequestInterface $request
        ) {
        ...
        self::$routes['/hk4e_global/mdk/shield/api/login'] = function (
            ServerRequestInterface $request
        ) {
            return new Response(
                200,
                ...
                json_encode([
                    "retcode" => 0,
                    "message" => "OK",
                    "data" => self::getSimpleAccountInfo(
                        69,
                        'labalityowo'
                    ),
        ...
        self::$routes['/hk4e_global/mdk/shield/api/verify'] = function (
            ServerRequestInterface $request
        ) {
            return new Response(
                200,
        ...
        self::$routes['/combo/box/api/config/sdk/combo'] = function (
            ServerRequestInterface $request
        ) {
            return new Response(
                200,
        ...
        self::$routes['/hk4e_global/mdk/shield/api/loadConfig'] = function (
            ServerRequestInterface $request
        ) {
            return new Response(
                200,
